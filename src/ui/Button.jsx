...
export default function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      base +
      "inline-block text-sm rounded-full border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:text-stone-50 hover:bg-stone-400 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed text-stone-400 px-4 py-2.5 md:px-6 md:py-3.5",
  };
